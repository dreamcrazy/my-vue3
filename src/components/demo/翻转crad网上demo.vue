<template>
  <div>
    ...
    <ceshiCmp :grid="grid" :gridFn="gridFn"></ceshiCmp>
...
<script setup>
  ...
  import ceshiCmp from './ceshi.vue'
...
$easeBounceStart: cubic-bezier(0.25, -0.24, 0.88, 0.9);
$easeBounceEnd: cubic-bezier(0.11, 0.11, 0.59, 1.3);
